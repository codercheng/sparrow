OBJS = sparrow.o thread_manage.o file.o ev_loop.o config.o async_log.o url.o min_heap.o cJSON.o mysql_encap.o conn_pool.o picohttpparser.o
CC = gcc
DEBUG = -g
CFLAGS = -Wall -c $(DEBUG)
...
sparrow.o: sparrow.c sparrow.h global.h  ev_loop.h async_log.h thread_manage.h config.h file.h mime.h url.h min_heap.h cJSON.h mysql_encap.h conn_pool.h picohttpparser.h
	g++ $(CFLAGS)  sparrow.c 
